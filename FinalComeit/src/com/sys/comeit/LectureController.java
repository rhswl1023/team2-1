...
public class LectureController
{
	...
	public String lectureCreate(Model model)
	{
	  ...
	  @RequestMapping(value = "/lectureinsert.action", method = {RequestMethod.GET
	  ,RequestMethod.POST}) public String lectureInsert(Model model, HttpServletRequest request) 
	  { 
