...
<head>
<meta charset="UTF-8">
<title>ProjectVoteList.jsp</title>
<link rel="stylesheet" type="text/css" href="<%=cp %>/assets/css/projectvotelist.css" >
	...
	<div class="row">
		<div class="col-md-12">
			...
			<div class="voteIng">
				...
				<div class="voteMem"><span class="glyphicon glyphicon-bullhorn icon" aria-hidden="true"></span><span>사안 : 홍길동 프로젝트장 방출</span></div>
				<div class="voteRsn"><span>사유 : 프로젝트장의 역할을 제대로 하지 않음</span></div>
			</div>
