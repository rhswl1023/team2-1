...
<div class="container-fluid">
	...
	<ul class="tabs tabsask">
        <li class="on"><a href="#tab1">일반 문의</a></li>
        <li><a href="#tab2">환불 문의</a></li>
    </ul>
